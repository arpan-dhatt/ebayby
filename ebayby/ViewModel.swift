...
""", ForegroundColor: Color.white),
    ...
    //User
    @Published var user: InfoModel.User = InfoModel.User.init(name: "Rishik", SocialCredit: 1, Location: "Washington D.C", Bio: "After becoming a neo-natel neurosurgon, Rishik grew bored of such a simple job, and set his sights higher. He launched his political career with ruthless eficinecy eliminating the competion, running unoppossed in all of his elections. The first Indian-American senetor, he was quickly able consolidate power with the help of the friendly corporations that drive the nations prosperity. Today, after passing numerous constitutional amendments that improved democracy by strengthening the power of the executive branch and by eliminating pesky term-limits. Rishik is truly a man of the people who matter.", ProfilePicture: UIImage(named: "Donlad")!, BabiesInCart: [], BabiesOrdered: [], age: "55", job: "President (NOT a Dicatator)", socialClass: "Ultra-Wealthy", subserviance: "Very High", intelligence: "Maximum")
